...
export default {
    ...
    // The default owner password is "password".
    // It is STRONGLY recommended to change this to a unique and strong password
    // to secure your server's Anti Cheats settings.
    ...
    "movement":{
        "fly":{
            ...
            "flyViolationThreshold": 3,
            "jumpBoostFactor": 4,
            "knockbackGraceTicks": 20
        },
        "speed":{
            "speedDifferenceThreshold": 4,
    ...
    "world":{
        ...
        "nuker":{
            ...
            "maxDeepOreBlocks": 1,
            "deepMineYLevel": 32,
            "valuableOres": ["minecraft:diamond_ore", "minecraft:deepslate_diamond_ore", "minecraft:ancient_debris"]
        },
        "worldborder":{
        ...
        "xrayDetection": {
            "enableSuspiciousOreCheck": true,
            "suspiciousOreThreshold": 5,
            "suspiciousOreTimeframeSeconds": 300,
            "valuableOresForSuspicion": ["minecraft:diamond_ore", "minecraft:deepslate_diamond_ore", "minecraft:ancient_debris", "minecraft:emerald_ore", "minecraft:deepslate_emerald_ore"]
        },
        "nightVisionDetection": {
            "enableNightVisionCheck": true,
            "checkIntervalTicks": 100,
            "minTimeInDarknessSeconds": 30,
            "darknessLightLevel": 0,
            "suspicionThreshold": 3,
            "maxPlayerSpeedWhenDark": 0.5
        }
    },
    "antiGrief": {
        "adminsBypass": true,
        "enableGlobalAntiGriefProperty": "ac:globalAntiGriefEnabled"
    },
    "itemInteractions": { 
        "fastUseCheck": {
            "enabled": true,
