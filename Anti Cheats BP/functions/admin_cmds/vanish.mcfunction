...
#notify
execute as @s[scores={vanish=1}] run tellraw @a[tag=admin,scores={ac:notify=1}] {"rawtext":[{"text":"§6[§eAnti Cheats Notify§6]§5§l "},{"selector":"@s[scores={vanish=1}]"},{"text":" §bvanished!§r"}]}
execute as @s[scores={vanish=0}] run tellraw @a[tag=admin,scores={ac:notify=1}] {"rawtext":[{"text":"§6[§eAnti Cheats Notify§6]§5§l "},{"selector":"@s[scores={vanish=0}]"},{"text":" §bre-appeared from vanish!§r"}]}